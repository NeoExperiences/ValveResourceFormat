...
namespace ValveResourceFormat.Blocks
{
    ...
    public class ResourceEditInfo2 : ResourceEditInfo
    {
        ...
        public Dictionary<string, Dictionary<string, long>> SubassetReferences { get; private set; }
        ...
        public override void Read(BinaryReader reader, Resource resource)
        {
            ...
            if (subassetReferences != null)
            {
                ...
                foreach (var property in subassetReferences)
                {
                    ...
                    var perTypeReferences = new Dictionary<string, long>(capacity: perTypeReferencesKv.Count);

                    foreach (var reference in perTypeReferencesKv)
                    {
                        perTypeReferences.Add(reference.Key, (long)reference.Value);
                    }
